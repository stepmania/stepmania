...
<xsl:comment>This file is automatically generated. Do not edit it.</xsl:comment>
	<html>
		<head>
			<title>StepMania API Reference</title>
			<style type="text/css">
			th {
...
<xsl:template match="sm:Lua">
	<div>
		<div id="header">
		<h2><a href="https://github.com/stepmania/stepmania/">StepMania</a> API Reference</h2><br/>
		<small>A collection of Lua bindings which can be used in themes for StepMania.</small>
		</div>
		<table id="sections">
			<thead>
				<tr>
	...
	<div>
		...
		<div class="sincestepmania">New in StepMania</div>
	...
	<xsl:choose>
		...
		<xsl:when test="string($elmt/@name)=$name">
			...
			<xsl:attribute name="class">
				<xsl:choose>
					<xsl:when test="contains($elmt/@since, 'StepMania')">sincestepmania</xsl:when>
