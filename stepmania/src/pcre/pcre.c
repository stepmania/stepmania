...
static void *pcre_malloc_int(size_t s) { return malloc(s); }
static void pcre_free_int(void *p) { free(p); }

void *(*pcre_malloc)(size_t) = pcre_malloc_int;
void  (*pcre_free)(void *) = pcre_free_int;
