...
CString ThemeManager::GetPathTo( ThemeElement te ) 
{
	...
	switch( te )
	{
		...
		case GRAPHIC_SCROLLBAR_PARTS:				sAssetPrefix = "Graphics\\scrollbar parts";			break;
		...
		case GRAPHIC_STYLE_ICONS:					sAssetPrefix = "Graphics\\Style icons 1x5";			break;
		...
		case GRAPHIC_DIFFICULTY_ICONS:					sAssetPrefix = "Graphics\\difficulty icons";					break;
		...
		case SOUND_FAILED:						sAssetPrefix = "Sounds\\failed";						break;
		case SOUND_ASSIST:						sAssetPrefix = "Sounds\\Assist";						break;
		case SOUND_SELECT:						sAssetPrefix = "Sounds\\select";						break;
		case SOUND_SWITCH_STYLE:				sAssetPrefix = "Sounds\\switch Style";				break;
		case SOUND_SWITCH_MUSIC:				sAssetPrefix = "Sounds\\switch music";				break;
		case SOUND_SWITCH_SORT:					sAssetPrefix = "Sounds\\switch sort";					break;
		case SOUND_EXPAND:						sAssetPrefix = "Sounds\\expand";						break;
		case SOUND_SWITCH_STEPS:				sAssetPrefix = "Sounds\\switch Steps";				break;
		case SOUND_TITLE_CHANGE:				sAssetPrefix = "Sounds\\title change";				break;
		case SOUND_MENU_SWOOSH:					sAssetPrefix = "Sounds\\menu swoosh";					break;
		case SOUND_MENU_BACK:					sAssetPrefix = "Sounds\\menu back";					break;
		case SOUND_INVALID:						sAssetPrefix = "Sounds\\invalid";						break;
		...
		case SOUND_SELECT_MODE_CHANGE:			sAssetPrefix = "Sounds\\select mode change";			break;
		case SOUND_MENU_MUSIC:					sAssetPrefix = "Sounds\\menu music";					break;
		case SOUND_ENDING_MUSIC:				sAssetPrefix = "Sounds\\ending music";				break;
