...
GameDef g_GameDefs[NUM_GAMES] = 
{
	...
	{	// GAME_IIDX
		...
		{	// m_iDefaultKeyboardKey
			{	// PLAYER_1
				...
				-1,					// IIDX_BUTTON_SCRATCHDOWN,
				SDLK_RETURN,		// IIDX_BUTTON_START,
				-1,					// IIDX_BUTTON_SELECT,
			...
			{	// PLAYER_2
				...
				-1,  				// IIDX_BUTTON_KEY6,
				-1,  				// IIDX_BUTTON_KEY7,
				-1,					// IIDX_BUTTON_SCRATCHUP,
				-1,					// IIDX_BUTTON_SCRATCHDOWN,
				-1,					// IIDX_BUTTON_START,
				-1,					// IIDX_BUTTON_SELECT,
				-1,					// IIDX_BUTTON_MENULEFT
				-1,					// IIDX_BUTTON_MENURIGHT
				-1,					// IIDX_BUTTON_MENUUP
				-1,					// IIDX_BUTTON_MENUDOWN
				-1,					// IIDX_BUTTON_COIN
				-1					// IIDX_BUTTON_OPERATOR
			},
		}
	},
	{	// GAME_MANIAX
	...
	{	// GAME_LIGHTS
		...
		{	// m_iDefaultKeyboardKey
			...
			{	// PLAYER_2
				-1,	//no default key		// LIGHTS_BUTTON_MARQUEE_UP_LEFT,
				-1,	//no default key		// LIGHTS_BUTTON_MARQUEE_UP_RIGHT,
				-1,	//no default key		// LIGHTS_BUTTON_MARQUEE_LR_LEFT,
				-1,	//no default key		// LIGHTS_BUTTON_MARQUEE_LR_RIGHT,
				...
				-1, //no default key		// LIGHTS_BUTTON_START,
				-1, //no default key		// LIGHTS_BUTTON_BACK
				-1, //no default key		// LIGHTS_BUTTON_MENULEFT
				-1, //no default key		// LIGHTS_BUTTON_MENURIGHT
				-1, //no default key		// LIGHTS_BUTTON_MENUUP
				-1, //no default key		// LIGHTS_BUTTON_MENUDOWN
				-1, //no default key		// LIGHTS_BUTTON_COIN
				-1, //no default key		// LIGHTS_BUTTON_OPERATOR
			},
		}
	},
};
