...
/*	{	// STYLE_DANCE_SOLO_VERSUS 
	...
	{	// STYLE_PNM_FIVE
		...
		{	// m_ColumnInfo[NUM_PLAYERS][MAX_COLS_PER_PLAYER];
			{	// PLAYER_1
				{ TRACK_1,	GAME_CONTROLLER_1,	PNM_BUTTON_LEFT_GREEN,	-PNM5_COL_SPACING*1.5f },
				{ TRACK_2,	GAME_CONTROLLER_1,	PNM_BUTTON_LEFT_BLUE,		-PNM5_COL_SPACING*0.5f },
				{ TRACK_3,	GAME_CONTROLLER_1,	PNM_BUTTON_RED,	-PNM5_COL_SPACING*0.0f },
				{ TRACK_4,	GAME_CONTROLLER_1,	PNM_BUTTON_RIGHT_BLUE,		+PNM5_COL_SPACING*0.5f },
				{ TRACK_5,	GAME_CONTROLLER_1,	PNM_BUTTON_RIGHT_GREEN,		+PNM5_COL_SPACING*1.5f },
			},
			{	// PLAYER_2
				{ TRACK_1,	GAME_CONTROLLER_2,	PNM_BUTTON_LEFT_GREEN,	-PNM5_COL_SPACING*1.5f },
				{ TRACK_2,	GAME_CONTROLLER_2,	PNM_BUTTON_LEFT_BLUE,		-PNM5_COL_SPACING*0.5f },
				{ TRACK_3,	GAME_CONTROLLER_2,	PNM_BUTTON_RED,	-PNM5_COL_SPACING*0.0f },
				{ TRACK_4,	GAME_CONTROLLER_2,	PNM_BUTTON_RIGHT_BLUE,		+PNM5_COL_SPACING*0.5f },
				{ TRACK_5,	GAME_CONTROLLER_2,	PNM_BUTTON_RIGHT_GREEN,		+PNM5_COL_SPACING*1.5f },
			},
		},
		{	// m_iColumnDrawOrder[MAX_COLS_PER_PLAYER];
			0,1,2,3,4
	...
	{	// STYLE_PNM_FIVE
		...
		{	// m_ColumnInfo[NUM_PLAYERS][MAX_COLS_PER_PLAYER];
			{	// PLAYER_1
				{ TRACK_1,	GAME_CONTROLLER_1,	PNM_BUTTON_LEFT_WHITE,	-PNM9_COL_SPACING*3.5f },
				{ TRACK_2,	GAME_CONTROLLER_1,	PNM_BUTTON_LEFT_YELLOW,		-PNM9_COL_SPACING*2.5f },
				{ TRACK_3,	GAME_CONTROLLER_1,	PNM_BUTTON_LEFT_GREEN,	-PNM9_COL_SPACING*1.5f },
				{ TRACK_4,	GAME_CONTROLLER_1,	PNM_BUTTON_LEFT_BLUE,		-PNM9_COL_SPACING*0.5f },
				{ TRACK_5,	GAME_CONTROLLER_1,	PNM_BUTTON_RED,	-PNM9_COL_SPACING*0.0f },
				{ TRACK_6,	GAME_CONTROLLER_1,	PNM_BUTTON_RIGHT_BLUE,		+PNM9_COL_SPACING*0.5f },
				{ TRACK_7,	GAME_CONTROLLER_1,	PNM_BUTTON_RIGHT_GREEN,		+PNM9_COL_SPACING*1.5f },
				{ TRACK_8,	GAME_CONTROLLER_1,	PNM_BUTTON_RIGHT_YELLOW,	+PNM9_COL_SPACING*2.5f },
				{ TRACK_9,	GAME_CONTROLLER_1,	PNM_BUTTON_RIGHT_WHITE,		+PNM9_COL_SPACING*3.5f },
			},
			{	// PLAYER_2
				{ TRACK_1,	GAME_CONTROLLER_2,	PNM_BUTTON_LEFT_WHITE,	-PNM9_COL_SPACING*3.5f },
				{ TRACK_2,	GAME_CONTROLLER_2,	PNM_BUTTON_LEFT_YELLOW,		-PNM9_COL_SPACING*2.5f },
				{ TRACK_3,	GAME_CONTROLLER_2,	PNM_BUTTON_LEFT_GREEN,	-PNM9_COL_SPACING*1.5f },
				{ TRACK_4,	GAME_CONTROLLER_2,	PNM_BUTTON_LEFT_BLUE,		-PNM9_COL_SPACING*0.5f },
				{ TRACK_5,	GAME_CONTROLLER_2,	PNM_BUTTON_RED,	-PNM9_COL_SPACING*0.0f },
				{ TRACK_6,	GAME_CONTROLLER_2,	PNM_BUTTON_RIGHT_BLUE,		+PNM9_COL_SPACING*0.5f },
				{ TRACK_7,	GAME_CONTROLLER_2,	PNM_BUTTON_RIGHT_GREEN,		+PNM9_COL_SPACING*1.5f },
				{ TRACK_8,	GAME_CONTROLLER_2,	PNM_BUTTON_RIGHT_YELLOW,	+PNM9_COL_SPACING*2.5f },
				{ TRACK_9,	GAME_CONTROLLER_2,	PNM_BUTTON_RIGHT_WHITE,		+PNM9_COL_SPACING*3.5f },
			},
		},
		{	// m_iColumnDrawOrder[MAX_COLS_PER_PLAYER];
			0,1,2,3,4,5,6,7,8
