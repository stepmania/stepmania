...
-- CD title
	...
	t[#t+1] = Def.ActorFrame {
		OnCommand=cmd(draworder,48;x,SCREEN_CENTER_X-420;y,SCREEN_CENTER_Y-147;zoom,0;sleep,0.5;decelerate,0.25;zoom,1;SetUpdateFunction,CDTitleUpdate);
		OffCommand=cmd(decelerate,0.3;zoomy,0);
		Def.Sprite {
			Name="CDTitle";
			OnCommand=cmd(draworder,48;zoom,0.75;diffusealpha,1;zoom,0;bounceend,0.35;zoom,0.75;);
