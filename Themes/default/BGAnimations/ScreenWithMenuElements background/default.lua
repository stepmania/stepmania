...
t[#t+1] = Def.ActorFrame {
  ...
  InitCommand=cmd(Center);
	...
	Def.ActorFrame {
		LoadActor("_pattern") .. {
			InitCommand=cmd(hide_if,hideFancyElements;rotationy,-12.25;rotationz,-30;rotationx,-20;zoomto,SCREEN_WIDTH*2,SCREEN_HEIGHT*2;customtexturerect,0,0,SCREEN_WIDTH*4/256,SCREEN_HEIGHT*4/256);
