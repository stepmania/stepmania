local t = Def.ActorFrame{
	Def.Quad{
		Name="TopLine";
		InitCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y*0.325;zoomto,SCREEN_WIDTH,2;diffuseleftedge,HSV(192,1,0.8);cropright,1);
	...
	Font("mentone","24px") .. {
		Text=HeaderString("PracticeSong");
		InitCommand=cmd(x,SCREEN_LEFT+32;y,SCREEN_CENTER_Y*0.31;zoomx,0.8;halign,0;valign,1;shadowlength,1;zoomy,0;strokecolor,color("0,0,0,0"));
