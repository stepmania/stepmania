local t = Def.ActorFrame{
	...
	Font("mentone","24px") .. {
		Text=HeaderString("AdvancedOptions");
		InitCommand=cmd(x,SCREEN_LEFT+32;y,SCREEN_CENTER_Y*0.355;addy,-SCREEN_CENTER_Y;zoom,0.8;halign,0;valign,1;shadowlength,1;strokecolor,color("0,0,0,0"));
