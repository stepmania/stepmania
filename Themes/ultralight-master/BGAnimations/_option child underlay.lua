...
local t = Def.ActorFrame{
	Def.Quad{
		Name="TopLine";
		InitCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y*0.4;addy,-SCREEN_CENTER_Y;zoomto,SCREEN_WIDTH,2;diffuseleftedge,HSV(192,1,0.8););
	...
	Font("mentone","24px") .. {
		...
		InitCommand=cmd(x,SCREEN_LEFT+32;y,SCREEN_CENTER_Y*0.38;addy,-SCREEN_CENTER_Y;zoom,0.8;halign,0;valign,1;shadowlength,1;strokecolor,color("0,0,0,0"));
	...
	Def.Quad{
		Name="BottomLine";
		InitCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y*1.5;addy,SCREEN_CENTER_Y;zoomto,SCREEN_WIDTH,2;diffuserightedge,HSV(192,1,0.8););
		OnCommand=cmd(linear,0.3;addy,-SCREEN_CENTER_Y);
		OffCommand=cmd(linear,0.3;addy,SCREEN_CENTER_Y);
