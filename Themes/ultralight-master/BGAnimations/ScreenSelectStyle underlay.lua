local t = Def.ActorFrame{
	Def.Quad{
		Name="TopLine";
		InitCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y*0.625;zoomto,SCREEN_WIDTH,2;diffuserightedge,HSV(192,1,0.8););
	...
	Def.Quad{
		Name="BottomLine";
		InitCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y*1.375;zoomto,SCREEN_WIDTH,2;diffuseleftedge,HSV(192,1,0.8););
